...
function Three500() {
  reactExports.useEffect(() => {
    window.dispatchEvent(new CustomEvent("three-500-ready"));
  }, []);
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: null, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { position: [0, 0, 0], children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Digit, { value: "5", position: [-6.5, 0.1, 0], color: "#f5da07", delay: 0.1 }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { position: [6.5, 0, 0], children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Stadium, { delay: 0.5, scale: 1.5 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { position: [-1.2, 0.8, -1.2], delay: 0.7 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { position: [0, 0.8, 1.5], delay: 0.9 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { position: [1.2, 0.8, -1.2], delay: 1.1 })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Helipad, { position: [5.7, 2, 2.5], delay: 0.5 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Helipad, { position: [-15, 2.1, -2], radius: 2, delay: 0, oscillate: false }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              HelicopterController,
              {
                targetPos: new Vector3(5.7, 2, 2.5),
...
function Page500() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 w-full h-full bg-[var(--blue-deep)] font-inter overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-0 pointer-events-none overflow-hidden opacity-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-[3] ", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "w-full h-full text-white/5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("pattern", { id: "hero-grid-500", x: "0", y: "0", width: "76", height: "76", patternUnits: "userSpaceOnUse", children: /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "5", y: "5", width: "66", height: "66", rx: "12", ry: "12", fill: "currentColor", fillOpacity: "1" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "100%", height: "100%", fill: "url(#hero-grid-500)" })
    ] }) }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 w-screen h-screen cursor-grab active:cursor-grabbing z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Three500, {}) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-0 left-0 right-0 p-[inherit] flex justify-between items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-[32px] sm:text-[40px] font-black leading-none tracking-tight", children: "500" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-[100px] sm:pt-[120px] pb-5 max-w-[600px]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.p,
          {
            ...
            className: "text-white/80 text-lg mb-6 pointer-events-auto",
            children: "Oops! Something went wrong on our end. We're working on fixing it."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.a,
...
const $$500 = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html lang="en" data-astro-cid-5v2qf5k4> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>500 - Server Error | DoSales</title><meta name="description" content="Oops! Something went wrong on our end. We're working on fixing it."><link rel="icon" type="image/svg+xml" href="/logos/dosales-logo.svg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700;900&display=swap" rel="stylesheet">${renderHead()}</head> <body data-astro-cid-5v2qf5k4> ${renderComponent($$result, "Page500", Page500, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/mehan/Step_7/calibraint/dosales-landing/src/components/500/Page500", "client:component-export": "default", "data-astro-cid-5v2qf5k4": true })} </body></html>`;
}, "/home/mehan/Step_7/calibraint/dosales-landing/src/pages/500.astro", void 0);

const $$file = "/home/mehan/Step_7/calibraint/dosales-landing/src/pages/500.astro";
const $$url = "/500";

...
const $$ = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>DoSales Admin | Sanity Studio</title>${renderHead()}</head> <body style="margin: 0; padding: 0;"> ${renderComponent($$result, "SanityStudio", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/home/mehan/Step_7/calibraint/dosales-landing/src/components/SanityStudio", "client:component-export": "default" })} </body></html>`;
}, "/home/mehan/Step_7/calibraint/dosales-landing/src/pages/admin/[...index].astro", void 0);

const $$file = "/home/mehan/Step_7/calibraint/dosales-landing/src/pages/admin/[...index].astro";

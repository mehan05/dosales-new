...
import { u as urlFor$1, a as cn, t as twMerge, d as deprecatedcreateImageUrlBuilder, b as dataset, p as projectId, $ as $$Layout, c as client } from '../chunks/astro-client_CTYSy9NU.mjs';
...
</p> <div class="flex gap-[4px] items-center"> ${[...Array(5)].map((_, i) => renderTemplate`<svg${addAttribute(i, "key")} width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="url(#star_grad)" stroke="#FFB627" stroke-width="1.2" stroke-linejoin="round"></path> </svg>`)} <svg width="0" height="0" class="absolute"> <defs> <linearGradient id="star_grad" x1="12" y1="2" x2="12" y2="22" gradientUnits="userSpaceOnUse"> <stop stop-color="#FFF282"></stop> <stop offset="1" stop-color="#FFB627"></stop> </linearGradient> </defs> </svg> </div> </div> </div> </div> </div> </section> ${renderScript($$result, "/home/mehan/Step_7/calibraint/dosales-landing/src/components/sections/Hero.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/mehan/Step_7/calibraint/dosales-landing/src/components/sections/Hero.astro", void 0);
...
}, "/home/mehan/Step_7/calibraint/dosales-landing/src/components/sections/WhyDoSales.astro", void 0);
...
}, "/home/mehan/Step_7/calibraint/dosales-landing/src/components/sections/EarlyAccess.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": settings.siteTitle, "description": settings.siteDescription, "settings": settings }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main id="main-content" class="flex-1"> ${renderComponent($$result2, "Hero", $$Hero, { "data": heroData })} ${renderComponent($$result2, "WhyDoSales", $$WhyDoSales, { "data": whyData })} <!-- Interactive Islands --> ${renderComponent($$result2, "DataSourcesSection", DataSourcesSection, { "client:visible": true, "data": finalRadarData, "client:component-hydration": "visible", "client:component-path": "/home/mehan/Step_7/calibraint/dosales-landing/src/components/sections/DataSourcesSection.tsx", "client:component-export": "default" })} ${renderComponent($$result2, "AIAgentSection", AIAgentSection, { "client:visible": true, "data": demoData, "testimonials": testimonials, "client:component-hydration": "visible", "client:component-path": "/home/mehan/Step_7/calibraint/dosales-landing/src/components/sections/AIAgentSection.tsx", "client:component-export": "default" })} ${renderComponent($$result2, "PlatformSection", PlatformSection, { "client:visible": true, "data": platformData, "client:component-hydration": "visible", "client:component-path": "/home/mehan/Step_7/calibraint/dosales-landing/src/components/sections/PlatformSection.tsx", "client:component-export": "default" })} ${renderComponent($$result2, "EarlyAccess", $$EarlyAccess, { "data": footerCta })} </main> ` })}`;
}, "/home/mehan/Step_7/calibraint/dosales-landing/src/pages/index.astro", void 0);

const $$file = "/home/mehan/Step_7/calibraint/dosales-landing/src/pages/index.astro";
const $$url = "";

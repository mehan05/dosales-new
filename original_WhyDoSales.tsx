...
export default function WhyDoSalesSection() {
  const statsWrapper = cn(
    "flex items-center justify-center gap-12 sm:gap-20",
    "py-10"
  );
  const statValue = "text-[40px] font-bold leading-[100%] tracking-[0%] text-[var(--color-brand)] text-center";
  const statLabel = "text-[16px] font-medium leading-[100%] tracking-[0%] text-gray-500 text-center mt-2";
  const registerButton = cn(
    "bg-[var(--color-text-primary)] hover:bg-gray-800 text-[var(--color-white)]",
    "w-[136px] h-[52px] px-4 rounded-[10px] font-medium text-[14px] leading-[100%] tracking-[0%] text-center",
    "transition-colors"
  );
  const eyebrow = cn(
  ...
  return (
    <section className="w-full bg-white flex flex-col items-center">
          ...
          <p className={cn(eyebrow, "bg-[linear-gradient(90deg,_#C5E7F7_0%,_#F4F9FB_100%)]")}>Why DoSales</p>
            ...
            Built exclusively for your market
              ...
              >
                <div className="w-full flex justify-center">
                  <Image
                    src="/screens/regional-dominance.svg"
                    alt="Map visualization showing DoSales dominance in B2B data coverage across MENA and Southeast Asia regions"
                    width={400}
                    height={250}
                    loading="lazy"
                    decoding="async"
              ...
              >
                <div className="w-full flex justify-center">
                  <Image
                    src="/screens/vertical-intelligence.svg"
                    alt="AI analytics interface showing vertical intelligence for industry-specific sales signals in Fintech and PropTech"
                    width={400}
                    height={250}
                    loading="lazy"
                    decoding="async"
              ...
              >
                ...
                <div className="w-full md:w-1/2 flex justify-center">
                  <Image
                    src="/screens/ai-autonomy.svg"
                    alt="Conceptual dashboard for AI autonomy showasing autonomous prospecting and lead enrichment workflows"
                    width={400}
                    height={250}
                    loading="lazy"
                    decoding="async"

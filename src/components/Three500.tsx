...
export default function Three500() {
  useEffect(() => {
      ...
      >
        ...
        <Suspense fallback={null}>
          ...
          <group position={[0, 0, 0]}>
            <Digit value="5" position={[-6.5, 0.1, 0]} color="#f5da07" delay={0.1} />
            ...
            <group position={[6.5, 0, 0]}>
              <Stadium delay={0.5} scale={1.5} />
              <Flag position={[-1.2, 0.8, -1.2]} delay={0.7} />
              <Flag position={[0.0, 0.8, 1.5]} delay={0.9} />
              <Flag position={[1.2, 0.8, -1.2]} delay={1.1} />
            </group>

            {/* Target Helipad placed slightly near the 5 */}
            <Helipad position={[5.7, 2.0, 2.5]} delay={0.5} />
            <Helipad position={[-15, 2.1, -2]} radius={2.0} delay={0} oscillate={false} />
            <HelicopterController 
              targetPos={new THREE.Vector3(5.7, 2.0, 2.5)} 

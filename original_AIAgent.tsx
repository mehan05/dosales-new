...
const testimonials = [
  { quote: "We’ve burned through Apollo and ZoomInfo licenses. The UAE Fintech data is a graveyard — wrong emails, outdated titles, companies that pivoted two years ago.", name: "Marcaus Teo", title: "VP Sales, Nium" },
  { quote: "We’ve burned through Apollo and ZoomInfo licenses. The UAE Fintech data is a graveyard — wrong emails, outdated titles, companies that pivoted two years ago.", name: "Talan Septimus", title: "Sales Director, Razorpay" },
  { quote: "We’ve burned through Apollo and ZoomInfo licenses. The UAE Fintech data is a graveyard — wrong emails, outdated titles, companies that pivoted two years ago.", name: "Jocelyn Kenter", title: "Growth Lead, Funding Societies" },
  { quote: "We’ve burned through Apollo and ZoomInfo licenses. The UAE Fintech data is a graveyard — wrong emails, outdated titles, companies that pivoted two years ago.", name: "Zain Septimus", title: "Head of BD, Sarwa" },
  { quote: "We’ve burned through Apollo and ZoomInfo licenses. The UAE Fintech data is a graveyard — wrong emails, outdated titles, companies that pivoted two years ago.", name: "Paityn Vaccaro", title: "Co-founder, Propseller" },
  { quote: "We’ve burned through Apollo and ZoomInfo licenses. The UAE Fintech data is a graveyard — wrong emails, outdated titles, companies that pivoted two years ago.", name: "Cristofer Curtis", title: "SDR Manager, Tabby" },
];
                  ...
                  <div className="flex flex-col gap-[18px]">
                    {[0, 1, 2].map((i) => (
                      <div key={`c1-${i}-${set}`} className="w-[312px] min-h-[186px] rounded-[16px] border border-[var(--color-bg-dark-surface-alt)] backdrop-blur-[44px] p-[16px] flex flex-col gap-[18px] shadow-lg shrink-0 whitespace-normal bg-[var(--color-bg-dark)]">
                        ...
                        >
                          {testimonials[i % 6].quote}
                        </p>
                        <div className="flex items-center gap-[12px] mt-auto">
                          <img
                            src={`/profile/profile${(i % 6) + 1}.svg`}
                            alt={`Profile picture of ${testimonials[i % 6].name}, ${testimonials[i % 6].title}`}
                            width={46}
                            height={46}
                            loading="lazy"
                            decoding="async"
